...
public class OrderedProperties extends LinkedHashMap<String, String> {
    ...
    private class LineReader {
        public LineReader(InputStream inStream) {
            ...
            type = ContentType.INSTREAM;
        }

        public LineReader(Reader reader) {
            this.reader = reader;
            inCharBuf = new char[8192];
            type = ContentType.READER;
        }

        public LineReader(String content) {
            inCharBuf = content.toCharArray();
    ...
    public OrderedProperties(String content) throws IOException {
        load0(new LineReader(content));
    }
